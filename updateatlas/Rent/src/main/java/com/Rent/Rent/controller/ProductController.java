...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getAllProductsByCategory(@PathVariable Category category) {
    ...
    @PostMapping("/users/{userId}/createproduct/")
      public ResponseEntity<Product> createProduct(
       ...
       Product product = productService.createProduct(name,description,price,location,Date,category);
    ...
    public ResponseEntity<String> updateProduct(
        ...
        Product updatedProduct = productService.updateProduct(userId, id, newName, newPrice, newDate,category);
